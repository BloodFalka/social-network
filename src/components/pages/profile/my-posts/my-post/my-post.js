...
import { createField, Textarea } from '../../../../common/forms-controls/forms-controls';
...
const MyPostForm = ({ handleSubmit, body }) => {
	return (
		<form onSubmit={handleSubmit} className="my-post-form">
			{createField([required, maxLength1000, minLength5], null, 'message', Textarea, {
...
const ReduxLoginForm = reduxForm({ form: 'edit-post' })(MyPostForm);
